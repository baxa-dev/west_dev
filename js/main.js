...
(() => {
	...
	function popupSlideshow(){
		...
		popupImg.src = imgSrc;
		popupImg.onload = () => {
			// deactivate loader adter the popupImg loaded
			popup.querySelector(".pp-loader").classList.remove("active");
		}
		popup.querySelector(".pp-counter").innerHTML = (slideIndex+1) + " из " + screenshots.length;
	}
	...
	function popupDetailsToggle(){
		const detailsbtn = projectDetailsBtn;
		if(projectDetailsContainer.classList.contains("active")){
